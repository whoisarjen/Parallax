<template>
  <header
    ...
    :class="scrolled ? 'bg-surface-950/80 backdrop-blur-xl border-b border-surface-800/50 shadow-lg shadow-black/5' : 'bg-transparent border-b border-transparent'"
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="flex items-center gap-1 sm:gap-2">
          <NuxtLink to="/my-boards" class="btn-ghost text-sm">
            My Boards
          </NuxtLink>
          <a
